...
BLOG_AUTHOR = "Jesper S Dramsch"  # (translatable)
BLOG_TITLE = "Machine Learning Geoscience"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://dramsch.net/phd/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://dramsch.net/phd/"
BLOG_EMAIL = "jesper@dramsch.net"
BLOG_DESCRIPTION = "Applications of Deep Neural Networks in 4D Seismic Data Analysis"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ("/abstract/", "Abstract"),
        ("/dansk-resume/", "Dansk Resumé"),
        ("/preface/", "Preface"),
        ("/introduction/", "1: Introduction"),
        ("/methods-theory/", "2: Methods & Theory"),
        ("/unsupervised-geological-image-segmentation/", "3: Unsupervised Geological Image Segmentation"),
        ("/transfer-learning-in-automatic-seismic-interpretation/", "4: Transfer learning in Automatic Seismic Interpretation"),
        ("/complex-valued-neural-networks/", "5: Complex-valued neural networks"),
        ("/machine-learning-in-4d-seismic-inversion/", "6: Machine Learning in 4D Seismic Inversion"),
        ("/3d-time-warping-for-4d-data/", "7: 3D Time Warping for 4D Data"),
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="https://dramsch.net">{author}</a>'
